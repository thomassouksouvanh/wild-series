 ...
 */
final class Version20191203085422 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('DROP INDEX sezson_id ON episode');
        $this->addSql('ALTER TABLE episode CHANGE sezson_id season_id INT NOT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE episode CHANGE season_id sezson_id INT NOT NULL');
        $this->addSql('CREATE INDEX sezson_id ON episode (sezson_id)');
